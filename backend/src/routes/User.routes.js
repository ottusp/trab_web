...
routes.post('/admin/', SessionMiddlewares.isAdmin, (req, res, next) => { req.isAdmin = true; next(); }, UserController.store);  // Create admin users (only a admin can create another admin)
